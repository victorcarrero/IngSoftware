...
if ($_SESSION["equipo"]["mostrar"] == -1) {
    header("Location: procesar/procesarMaratonesActivas.php");
}
?>
<!DOCTYPE html>
<html>
        ...
        <div class="ufps-container">
            <div class="ufps-panel" >
                <form name="formulario" id="formulario" action="" method="post">
                    <h1 class="ufps-text-center">Maratones Inscritas</h1>
                    <table class="ufps-table ufps-table-inserted ufps-text-center">
                        <thead>
                            <tr>
                                ...
                                <th data-field="anular">Anular</th>
                                <th data-field="ingresar">Ingresar</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
